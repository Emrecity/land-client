...
const DeleteButton = ({ handleClick, title }: buttonProps) => {
    return (
        <button className="text-red-400 hover:text-red-600 w-auto btn rounded-md" onClick={handleClick} title={title ?? "Delete"}>
